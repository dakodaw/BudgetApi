...
namespace Budget.DB.Migrations
{
    ...
    [Migration("20250105193854_ForeignKeyBudgetGroupIdCleanup")]
    partial class ForeignKeyBudgetGroupIdCleanup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Budget.DB.PurchaseEntity", b =>
                {
                    ...
                    b.Property<Guid?>("ReceiptRecordGroupId")
            ...
            modelBuilder.Entity("Budget.DB.ReceiptRecordEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReceiptRecord", (string)null);
                });

            modelBuilder.Entity("Budget.DB.ReceiptRecordGroupEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ReceiptRecordId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReceiptRecordId");

                    b.ToTable("ReceiptRecordGroup", (string)null);
                });
            ...
            modelBuilder.Entity("Budget.DB.UsersBudgetingGroupEntity", b =>
                {
                    ...
                    b.Property<int>("UserBudgetingGroupId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Budget.DB.ReceiptRecordGroupEntity", b =>
                {
                    ...
                    b.HasOne("Budget.DB.ReceiptRecordEntity", "ReceiptRecord")
                        .WithMany()
                        .HasForeignKey("ReceiptRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
